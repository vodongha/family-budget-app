...
| **Currency converter** | A hub tool to convert any amount between two currencies using the live rates (with a swap button and the current rate); display-only — it never touches your wallets. |
